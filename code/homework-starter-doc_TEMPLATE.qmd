...
**Leaf dry weight is weakly positively correlated with specific leaf area (Pearson's r = 0.033**  

**Shoot mass and total mass are strongly positively correlated (Pearson's r = 0.902)**  

**Leaf dry weight is strongly positively correlated with total mass (Pearson's r = 0.046**
...
#one easy way to get out pattenrs is to reorder x axis in reverse order of mean total mass 
...
Out of the four models we have tried, the best model is the one that includes **Specific leaf area, water treatment, and species (saturated models) 
